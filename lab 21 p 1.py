...
class SimpleAPIClient:
    """
    A simple Python class to interact with the JSONPlaceholder API's /posts endpoint.
    """

    def __init__(self, base_url: str = 'https://jsonplaceholder.typicode.com'):
        """
        Initializes the client. Sets the full endpoint URL for posts.
        """
    ...
    def fetch_post(self, post_id: int) -> Optional[Dict]:
        """
        Performs a GET request to fetch a single post by ID.
        """
...
# Test GET method: fetch post with ID 10
post_10 = client.fetch_post(post_id=10)
if post_10:
    print(f"Post Title: {post_10['title']}")

# Test POST method: create a new post
