...
multiple_student_subjects = [
    (92400133075, 'Chiragsinh', 'PWP', 100),
    (92400133075, 'Chiragsinh', 'ICE', 91),
    (92400133075, 'Chiragsinh', 'DMGT', 100),
    (92400133075, 'Chiragsinh', 'DSC', 100),
    (92400133075, 'Chiragsinh', 'SS', 92),
    (92400133075, 'Chiragsinh', 'COA', 95)
]
cursor.executemany('''
...
cursor.execute('''
    ...
    SET Mark = 98 
    WHERE Enrollment = 92400133075 AND Subject = 'ICE'
''')
conn.commit()
...
cursor.execute('''
    ...
    WHERE Enrollment = 92400133075 AND Subject = 'DMGT'
''')
conn.commit()
